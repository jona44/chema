...
urlpatterns = [
     ...
     path('toggle_deceased_api/<int:deceased_id>/', views.toggle_deceased_api, name='toggle_deceased_api'),
     path('stop_contributions_api/<int:deceased_id>/', views.stop_contributions_api, name='stop_contributions_api'),
