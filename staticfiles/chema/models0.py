...
class Group(models.Model):
    ...
    dependent =  models.ForeignKey('Dependent', on_delete=models.CASCADE, related_name='',null=True, blank=True)
    deceased  =  models.BooleanField(default=False)
    is_active =  models.BooleanField(default=True)
    group_admin = models.ForeignKey('GroupAdmin', on_delete=models.CASCADE, related_name='admins',null=True, blank=True)
...
class GroupAdmin(models.Model):
    groups   = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='group_admins',null=True, blank=True)
    profile = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='admin_groups',null=True, blank=True)
    # other fields...
